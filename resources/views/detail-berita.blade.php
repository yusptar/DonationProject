    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          ...
          <a href="/" class="logo me-auto me-lg-6"><img src="{{ asset('user/assets/img/logo-yayasan.png') }}" alt="" class="responsive"></a>
          ...
          <div class="col-lg-8">
            <div class="berita-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="">
                  <img src="{{ url('storage/images/'.$berita->image) }}" class="responsive" alt="">
                </div>

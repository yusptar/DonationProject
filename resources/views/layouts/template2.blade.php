...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    <div class="p-2"><img src="{{ asset('admins/assets/images/users/1.jpg') }}" alt="user" width="50"
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ asset('admins/assets/images/users/4.jpg') }}" alt="user" width="50"
                                            class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ asset('admins/assets/images/users/5.jpg') }}" alt="user" width="50"
                                            class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="{{ asset('admins/assets/images/users/1.jpg') }}" alt="user"
                                                ...
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="{{ asset('admins/assets/images/users/4.jpg') }}" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{ asset('admins/assets/images/users/1.jpg') }}" alt="user">
                                            </div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{ asset('admins/assets/images/users/2.jpg') }}" alt="user">
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{ asset('admins/assets/images/users/3.jpg') }}" alt="user">
                                            </div>
                                            <div class="chat-content">
    ...
    <script src="{{ asset('admins/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    ...
    <!-- Charts js Files -->
    <script src="{{ asset('admins/assets/libs/flot/excanvas.js') }}"></script>
    <script src="{{ asset('admins/assets/libs/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('admins/assets/libs/flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('admins/assets/libs/flot/jquery.flot.time.js') }}"></script>
    <script src="{{ asset('admins/assets/libs/flot/jquery.flot.stack.js') }}"></script>
